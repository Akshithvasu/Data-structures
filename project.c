...
struct Employee *searchEmployeeByName(struct Employee *root, const char *name) {
    if (root == NULL || strcmp(name, root->name) == 0) {
        return root;
    }

    if (strcmp(name, root->name) < 0) {
        return searchEmployeeByName(root->left, name);
    } else {
...
void searchEmployeesByDesignation(struct Employee *root, const char *designation) {
    if (root == NULL) {
        return;
    }

    searchEmployeesByDesignation(root->left, designation);

    if (strcmp(designation, root->designation) == 0) {
        displayEmployee(root);
    }

    searchEmployeesByDesignation(root->right, designation);
}
...
int main() {
    ...
    do {
        ...
        printf("5. Search Employees by Designation\n");
        printf("6. Count Employees\n");
        printf("7. Display Employee Tree Structure\n");
        printf("8. Display Employee Tree Structure(post-order traversal\n");
        printf("9. Display Employee Tree Structure(pre-order traversal\n");
        ...
        switch (choice) {
            ...
            case 3: {
                ...
                scanf("%s", name);
                struct Employee *foundEmployee = searchEmployeeByName(root, name);
            ...
            case 5: {
                ...
                scanf("%s", designation);
                searchEmployeesByDesignation(root, designation);
                break;
            }
            case 6: {
